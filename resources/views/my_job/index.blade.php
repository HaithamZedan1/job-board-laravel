...
<div class="text-xs text-slate-500">
    ...
    <div class="mb-4 flex items-center justify-between">
        <div>
            ...
            <div>
            <a href="{{ route('download.cv', ['path' => $application->cv_path]) }}" class="text-indigo-500 font-medium hover:underline">
                Download CV
            </a>
            </div>
        </div>
    ...
    <div class="flex items-center justify-between">
        ...
        @csrf
        @method("DELETE")
        <x-button class="bg-red-400 hover:bg-red-200">Delete</x-button>
        </form>
    </div>
</div>
</x-job-card>
